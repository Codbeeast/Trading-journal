...
const plansData = [
    ...
    },
    {
        ...
        features: [
            ...
            { name: 'Performance tracking', description: 'Monitor your progress over time', included: true },
            { name: 'Psychology analysis', description: 'Understand your trading mindset', included: true },
            { name: '1 bonus month FREE', description: 'Get 7 months for the price of 6', included: true },
            { name: '7-day free trial', description: 'Try before you subscribe', included: true },
        ],
        isPopular: true,
        displayOrder: 2,
    ...
    },
    {
        ...
        features: [
            ...
            { name: 'Performance tracking', description: 'Monitor your progress over time', included: true },
            { name: 'Psychology analysis', description: 'Understand your trading mindset', included: true },
            { name: 'Priority support', description: 'Get faster response times', included: true },
            { name: '2 bonus months FREE', description: 'Get 14 months for the price of 12', included: true },
            { name: '7-day free trial', description: 'Try before you subscribe', included: true },
        ],
        isPopular: false,
        displayOrder: 3,
