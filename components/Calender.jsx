  ...
  return (
    ...
    <div className="w-full min-h-auto bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-2 sm:p-4 lg:p-6">
      ...
      <div className="flex flex-col gap-4 lg:gap-6 max-w-full mx-auto"> {/* Added max-w-7xl mx-auto to control overall width */}
        ...
        {/* Main Calendar Grid - Mobile vs Desktop Layout */}

        <div className="relative z-10 w-full">

          

          {/* Desktop Layout: Calendar + Weekly Summaries Side by Side */}
          ...
          {/* Mobile Layout: Calendar First, Then Weekly Summaries Below */}

          <div className="md:hidden">

            {/* Mobile Calendar Grid - Just the days */}
            ...
            {/* Mobile Weekly Summaries Section */}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {weeks.map((week, weekIndex) => {
                  ...
                  // Only render weekly summary if the week has actual dates
