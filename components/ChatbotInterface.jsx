      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar p-3 sm:p-8 space-y-4 sm:space-y-8 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent relative z-10">
        <AnimatePresence mode="wait">
          {messages.length === 0 && (
            ...
            >
              <motion.div 
                className="w-16 h-16 sm:w-24 sm:h-24 bg-black/30 backdrop-blur-lg rounded-3xl shadow-lg border border-white/10 flex items-center justify-center mx-auto mb-6 mt-12 sm:mb-8 relative overflow-hidden"
                animate={{ 
                  boxShadow: [
