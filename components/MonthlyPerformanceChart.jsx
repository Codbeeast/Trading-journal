...
const MonthlyPerformanceChart = () => {
    ...
    return (
      <div className="relative group">
        ...
        <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
          ...
          <div className="h-[500px] sm:h-[350px] bg-gray-600/20 rounded-lg animate-pulse flex items-center justify-center">
    ...
    return (
      <div className="relative group">
        ...
        <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
          ...
          <div className="h-[500px] sm:h-[350px] flex items-center justify-center text-red-400">
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
        <h2 className="text-xl font-bold text-white mb-4">Monthly Performance Overview</h2>
        <ResponsiveContainer width="100%" height={500} className="sm:h-[350px]">
