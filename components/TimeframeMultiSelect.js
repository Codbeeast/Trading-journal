...
const TimeframeMultiSelect = ({ 
  ...
  const handleToggle = (timeframe) => {
    ...
    onChange(rowId, 'timeFrame', newValue);
  };
  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={disabled}
        className={`w-full flex items-center justify-between rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-400 border ${
          disabled 
