  ...
  return (
    <div className="relative w-full h-full">
      ...
      >
        {/* Inner card content */}
        <div
          className="relative flex flex-col justify-start items-start p-[20px] rounded-2xl overflow-hidden w-full h-full"
          style={{
            backgroundImage:
        ...
        >
          ...
          <div className="flex flex-col items-start w-full mb-3">
            ...
            >
              {title || 'Discover Your Most Profitable Session'}
            </h2>
          ...
          <div className="flex-1 flex items-center justify-center w-full min-h-0 relative" style={{ minHeight: '180px' }}>
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <div className="relative z-10 w-full h-full flex items-center justify-center">
                <Image
                  src="/Feature/image_4.png"
                  alt="Discover Your Most Profitable Session"
                  width={400}
                  height={300}
